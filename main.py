...
def entity_extractor(question):
    result = openai.ChatCompletion.create(
        ...
        messages=[
            {"role": "system",
             "content": question +  " Answer the question truthfully based on the given text below. Include quotes and a comment where to find it in the text (paragraph). After the quote write a step by step explanation. Use bullet points. Given text:" +  pdf_text_result_ }
